...
public class intro extends Activity implements B4AActivity{
	public static intro mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.intro");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (intro).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.intro");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.intro", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (intro) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (intro) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (intro) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static myk.b4a.objects.Timer _timer1 = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"intro\")";
mostCurrent._activity.LoadLayout("intro",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="introwel.Initialize2(\"introwel\")";
mostCurrent._introwel.Initialize2(processBA,"introwel");
 //BA.debugLineNum = 27;BA.debugLine="introwel.Load(File.DirAssets, \"intro.mp3\")";
mostCurrent._introwel.Load(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"intro.mp3");
 //BA.debugLineNum = 28;BA.debugLine="timer1.Initialize(\"timer1\",50)";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="Dim  introwel As MediaPlayer";
mostCurrent._introwel = new anywheresoftware.b4a.objects.MediaPlayerWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Dim ProgressBar1 As ProgressBar";
mostCurrent._progressbar1 = new anywheresoftware.b4a.objects.ProgressBarWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim num As Int";
_num = 0;
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub timer1_tick";
