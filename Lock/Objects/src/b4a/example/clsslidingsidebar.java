    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ...
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "b4a.example.clsslidingsidebar",
                    ba);
                return;
		    }
        }
...
public myk.b4a.objects.PanelWrapper _pnlcontent = null;
public myk.b4a.objects.PanelWrapper _pnlsidebar = null;
public myk.b4a.objects.PanelWrapper _pnlgesture = null;
public myk.b4a.objects.PanelWrapper _sbparent = null;
...
__c.CallSubNew2(ba,_sbmodule,_sbsubmove,(Object)(__c.Not(_close)));
 ...
 //BA.debugLineNum = 262;BA.debugLine="DoEvents 'Processes the draw messages and kee";
__c.DoEvents();
...
;
 //BA.debugLineNum = 464;BA.debugLine="Return 0";
...
switch (BA.switchObjectToInt(_sbposition,(byte) (0),(byte) (1),(byte) (2),(byte) (3))) {
case 0:
 //BA.debugLineNum = 374;BA.debugLine="pnlGesture.SetLayout(pnlContent.Left, 0, Gestu";
_pnlgesture.SetLayout(_pnlcontent.getLeft(),(int) (0),_gestureareasize,_getparentheight());
 break;
case 1:
 //BA.debugLineNum = 376;BA.debugLine="pnlGesture.SetLayout(pnlContent.Left + pnlCont";
_pnlgesture.SetLayout((int) (_pnlcontent.getLeft()+_pnlcontent.getWidth()),(int) (0),_gestureareasize,_getparentheight());
 break;
case 2:
 //BA.debugLineNum = 378;BA.debugLine="pnlGesture.SetLayout(0, pnlContent.Top, getPar";
_pnlgesture.SetLayout((int) (0),_pnlcontent.getTop(),_getparentwidth(),_gestureareasize);
 break;
case 3:
 //BA.debugLineNum = 380;BA.debugLine="pnlGesture.SetLayout(0, pnlContent.Top + pnlCo";
_pnlgesture.SetLayout((int) (0),(int) (_pnlcontent.getTop()+_pnlcontent.getHeight()),_getparentwidth(),_gestureareasize);
 break;
}
;
 }else {
...
_sbparent.AddView((android.view.View)(_pnlgesture.getObject()),_pnlcontent.getLeft(),(int) (0),_gestureareasize,_getparentheight());
 break;
case 1:
 //BA.debugLineNum = 388;BA.debugLine="sbParent.AddView(pnlGesture, pnlContent.Left +";
_sbparent.AddView((android.view.View)(_pnlgesture.getObject()),(int) (_pnlcontent.getLeft()+_pnlcontent.getWidth()),(int) (0),_gestureareasize,_getparentheight());
 break;
case 2:
 //BA.debugLineNum = 390;BA.debugLine="sbParent.AddView(pnlGesture, 0, pnlContent.Top";
_sbparent.AddView((android.view.View)(_pnlgesture.getObject()),(int) (0),_pnlcontent.getTop(),_getparentwidth(),_gestureareasize);
 break;
case 3:
 //BA.debugLineNum = 392;BA.debugLine="sbParent.AddView(pnlGesture, 0, pnlContent.Top";
_sbparent.AddView((android.view.View)(_pnlgesture.getObject()),(int) (0),(int) (_pnlcontent.getTop()+_pnlcontent.getHeight()),_getparentwidth(),_gestureareasize);
 break;
}
;
...
int _oldpos = 0;
 //BA.debugLineNum = 476;BA.debugLine="Private Sub Gesture_onTouch(ViewTag As Object, Act";
 //BA.debugLineNum = 477;BA.debugLine="If Action = 0 Then";
if (_action==0) { 
 //BA.debugLineNum = 478;BA.debugLine="Dim Obj As View = GetViewAtXY(pnlGesture.Left +";
_obj = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
_obj.setObject((android.view.View)(_getviewatxy((float) (_pnlgesture.getLeft()+_x),_y)));
 //BA.debugLineNum = 479;BA.debugLine="If Obj.IsInitialized AND (Obj.Tag <> \"1\") Then";
if (_obj.IsInitialized() && ((_obj.getTag()).equals((Object)("1")) == false)) { 
 //BA.debugLineNum = 480;BA.debugLine="Return False";
if (true) return __c.False;
 };
 //BA.debugLineNum = 483;BA.debugLine="sbStopAnim = True";
_sbstopanim = __c.True;
 //BA.debugLineNum = 484;BA.debugLine="sbStartX = X";
_sbstartx = (int) (_x);
 //BA.debugLineNum = 485;BA.debugLine="sbStartY = Y";
_sbstarty = (int) (_y);
 }else if(_action==2) { 
 //BA.debugLineNum = 488;BA.debugLine="Dim OldPos As Int";
_oldpos = 0;
 //BA.debugLineNum = 489;BA.debugLine="Select sbPosition";
switch (BA.switchObjectToInt(_sbposition,(byte) (0),(byte) (1),(byte) (2),(byte) (3))) {
case 0:
...
_oldpos = _pnlsidebar.getLeft();
 //BA.debugLineNum = 493;BA.debugLine="pnlSidebar.Left = Max(-pnlSidebar.Width, Min(";
...
_oldpos = _pnlcontent.getLeft();
 //BA.debugLineNum = 498;BA.debugLine="pnlContent.Left = Max(0, Min(pnlContent.Left";
...
if (_sbanimtype==2) { 
 //BA.debugLineNum = 506;BA.debugLine="OldPos = pnlSidebar.Left";
_oldpos = _pnlsidebar.getLeft();
 //BA.debugLineNum = 507;BA.debugLine="pnlSidebar.Left = Max(pnlContent.Width - pnlS";
_pnlsidebar.setLeft((int) (__c.Max(_pnlcontent.getWidth()-_pnlsidebar.getWidth(),__c.Min(_pnlsidebar.getLeft()+_x-_sbstartx,_pnlcontent.getWidth()))));
 //BA.debugLineNum = 508;BA.debugLine="If sbHandle.IsInitialized Then sbHandle.Left";
if (_sbhandle.IsInitialized()) { 
_sbhandle.setLeft((int) (_sbhandle.getLeft()-_oldpos+_pnlsidebar.getLeft()));};
 //BA.debugLineNum = 509;BA.debugLine="If pnlGesture.IsInitialized Then pnlGesture.L";
if (_pnlgesture.IsInitialized()) { 
_pnlgesture.setLeft((int) (_pnlgesture.getLeft()-_oldpos+_pnlsidebar.getLeft()));};
 }else {
 //BA.debugLineNum = 511;BA.debugLine="OldPos = pnlContent.Left";
_oldpos = _pnlcontent.getLeft();
 //BA.debugLineNum = 512;BA.debugLine="pnlContent.Left = Max(-pnlSidebar.Width, Min(";
_pnlcontent.setLeft((int) (__c.Max(-_pnlsidebar.getWidth(),__c.Min(_pnlcontent.getLeft()+_x-_sbstartx,0))));
 //BA.debugLineNum = 513;BA.debugLine="If sbAnimType = 1 Then pnlSidebar.Left = pnlC";
if (_sbanimtype==1) { 
_pnlsidebar.setLeft((int) (_pnlcontent.getLeft()+_pnlcontent.getWidth()));};
 //BA.debugLineNum = 514;BA.debugLine="If sbHandle.IsInitialized Then sbHandle.Left";
if (_sbhandle.IsInitialized()) { 
_sbhandle.setLeft((int) (_sbhandle.getLeft()-_oldpos+_pnlcontent.getLeft()));};
 //BA.debugLineNum = 515;BA.debugLine="If pnlGesture.IsInitialized Then pnlGesture.L";
if (_pnlgesture.IsInitialized()) { 
_pnlgesture.setLeft((int) (_pnlgesture.getLeft()-_oldpos+_pnlcontent.getLeft()));};
 };
 //BA.debugLineNum = 517;BA.debugLine="sbIsOpening = X < sbStartX";
_sbisopening = _x<_sbstartx;
 break;
case 2:
...
_oldpos = _pnlsidebar.getTop();
 //BA.debugLineNum = 521;BA.debugLine="pnlSidebar.Top = Max(-pnlSidebar.Height, Min(";
...
_oldpos = _pnlcontent.getTop();
 //BA.debugLineNum = 526;BA.debugLine="pnlContent.Top = Max(0, Min(pnlContent.Top +";
...
_sbisopening = _y>_sbstarty;
 break;
case 3:
 //BA.debugLineNum = 533;BA.debugLine="If sbAnimType = 2 Then";
if (_sbanimtype==2) { 
 //BA.debugLineNum = 534;BA.debugLine="OldPos = pnlSidebar.Top";
_oldpos = _pnlsidebar.getTop();
 //BA.debugLineNum = 535;BA.debugLine="pnlSidebar.Top = Max(pnlContent.Height - pnlS";
_pnlsidebar.setTop((int) (__c.Max(_pnlcontent.getHeight()-_pnlsidebar.getHeight(),__c.Min(_pnlsidebar.getTop()+_y-_sbstarty,_pnlcontent.getHeight()))));
 //BA.debugLineNum = 536;BA.debugLine="If sbHandle.IsInitialized Then sbHandle.Top =";
if (_sbhandle.IsInitialized()) { 
_sbhandle.setTop((int) (_sbhandle.getTop()-_oldpos+_pnlsidebar.getTop()));};
 //BA.debugLineNum = 537;BA.debugLine="If pnlGesture.IsInitialized Then pnlGesture.T";
if (_pnlgesture.IsInitialized()) { 
_pnlgesture.setTop((int) (_pnlgesture.getTop()-_oldpos+_pnlsidebar.getTop()));};
 }else {
 //BA.debugLineNum = 539;BA.debugLine="OldPos = pnlContent.Top";
_oldpos = _pnlcontent.getTop();
 //BA.debugLineNum = 540;BA.debugLine="pnlContent.Top = Max(-pnlSidebar.Height, Min(";
_pnlcontent.setTop((int) (__c.Max(-_pnlsidebar.getHeight(),__c.Min(_pnlcontent.getTop()+_y-_sbstarty,0))));
 //BA.debugLineNum = 541;BA.debugLine="If sbAnimType = 1 Then pnlSidebar.Top = pnlCo";
if (_sbanimtype==1) { 
_pnlsidebar.setTop((int) (_pnlcontent.getTop()+_pnlcontent.getHeight()));};
 //BA.debugLineNum = 542;BA.debugLine="If sbHandle.IsInitialized Then sbHandle.Top =";
if (_sbhandle.IsInitialized()) { 
_sbhandle.setTop((int) (_sbhandle.getTop()-_oldpos+_pnlcontent.getTop()));};
 //BA.debugLineNum = 543;BA.debugLine="If pnlGesture.IsInitialized Then pnlGesture.T";
if (_pnlgesture.IsInitialized()) { 
_pnlgesture.setTop((int) (_pnlgesture.getTop()-_oldpos+_pnlcontent.getTop()));};
 };
 //BA.debugLineNum = 545;BA.debugLine="sbIsOpening = Y < sbStartY";
_sbisopening = _y<_sbstarty;
 break;
}
;
 //BA.debugLineNum = 547;BA.debugLine="sbIsVisible = (CalcDistance(FROM_CLOSE) <> 0)";
_sbisvisible = (_calcdistance(_from_close)!=0);
 //BA.debugLineNum = 550;BA.debugLine="If SubExists(sbModule, sbSubMove) Then";
if (__c.SubExists(ba,_sbmodule,_sbsubmove)) { 
 //BA.debugLineNum = 551;BA.debugLine="If sbIsOpening Then";
if (_sbisopening) { 
 //BA.debugLineNum = 552;BA.debugLine="CallSub2(sbModule, sbSubMove, True)";
__c.CallSubNew2(ba,_sbmodule,_sbsubmove,(Object)(__c.True));
 }else {
 //BA.debugLineNum = 554;BA.debugLine="CallSub2(sbModule, sbSubMove, False)";
__c.CallSubNew2(ba,_sbmodule,_sbsubmove,(Object)(__c.False));
 };
 };
 }else if(_action==1) { 
 //BA.debugLineNum = 560;BA.debugLine="If sbFinalMovement > 0 AND sbIsVisible Then";
if (_sbfinalmovement>0 && _sbisvisible) { 
 //BA.debugLineNum = 561;BA.debugLine="If sbFinalMovement = 2 Then sbIsOpening = Abs(C";
if (_sbfinalmovement==2) { 
_sbisopening = __c.Abs(_calcdistance(_from_close))>=__c.Abs(_calcdistance(_from_open));};
 //BA.debugLineNum = 562;BA.debugLine="If sbIsOpening Then";
if (_sbisopening) { 
 //BA.debugLineNum = 563;BA.debugLine="CallSubDelayed2(Me, \"AnimateSidebar\", OPEN_ANI";
__c.CallSubDelayed2(ba,this,"AnimateSidebar",(Object)(_open_anim));
 }else {
 //BA.debugLineNum = 565;BA.debugLine="CallSubDelayed2(Me, \"AnimateSidebar\", CLOSE_AN";
__c.CallSubDelayed2(ba,this,"AnimateSidebar",(Object)(_close_anim));
 };
 }else {
 //BA.debugLineNum = 568;BA.debugLine="TriggerFinalEvent";
_triggerfinalevent();
 };
 };
...
public Object  _getviewatxy(float _x,float _y) throws Exception{
anywheresoftware.b4a.objects.ConcreteViewWrapper _v = null;
 //BA.debugLineNum = 467;BA.debugLine="Private Sub GetViewAtXY(X As Float, Y As Float) As";
 //BA.debugLineNum = 468;BA.debugLine="For Each v As View In pnlContent.GetAllViewsRecur";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
final anywheresoftware.b4a.BA.IterableList group369 = _pnlcontent.GetAllViewsRecursive();
final int groupLen369 = group369.getSize();
for (int index369 = 0;index369 < groupLen369 ;index369++){
_v.setObject((android.view.View)(group369.Get(index369)));
 //BA.debugLineNum = 469;BA.debugLine="If X >= v.Left AND X <= v.Left + v.Width AND";
if (_x>=_v.getLeft() && _x<=_v.getLeft()+_v.getWidth() && _y>=_v.getTop() && _y<=_v.getTop()+_v.getHeight()) { 
 //BA.debugLineNum = 470;BA.debugLine="Return v";
if (true) return (Object)(_v.getObject());
 };
 }
;
...
public String  _triggerfinalevent() throws Exception{
 //BA.debugLineNum = 574;BA.debugLine="Sub TriggerFinalEvent";
 //BA.debugLineNum = 576;BA.debugLine="If CalcDistance(FROM_OPEN) = 0 AND SubExists(sbMo";
if (_calcdistance(_from_open)==0 && __c.SubExists(ba,_sbmodule,_sbsubfullyopen)) { 
 //BA.debugLineNum = 577;BA.debugLine="CallSub(sbModule, sbSubFullyOpen)";
__c.CallSubNew(ba,_sbmodule,_sbsubfullyopen);
 ...
 //BA.debugLineNum = 579;BA.debugLine="CallSub(sbModule, sbSubFullyClosed)";
