...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("slideLock")
	Activity.Title = AppLabel & ": " & Activity.Title
	BtnPreview.Left = 0%x
BtnPreview.width = 100%x

Panel1.Left = 0%x
Panel1.width = 100%x

BtnEnableService.Left = 0%x
BtnEnableService.width = 100%x

BtnEnableHomeBlocker.Left = 0%x
BtnEnableHomeBlocker.width = 100%x
End Sub
